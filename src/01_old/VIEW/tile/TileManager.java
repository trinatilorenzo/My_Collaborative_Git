...
public class TileManager {
    ...
    public TileManager(GameSetting gs){
        ...
        this.tile = new Tile[gs.TILENUM];
        mapTileNum = new int[gs.MAX_WORLD_ROW][gs.MAX_WORLD_COL];

        // load all old.VIEW.tile asset
        getTileImage();
        // load old.VIEW.tile map
        loadTileMap(gs.MAP_PATH);
    }
    ...
    public void getTileImage(){
        ...
        try {
            ...
            tile[1] = new Tile();
            tile[1].image = ImageIO.read(getClass().getResourceAsStream("/res/tiles/003.png"));
    ...
    public void loadTileMap(String pathFile){
        try {
            ...
            for (int j = 0; j < gs.MAX_WORLD_COL; j++) {
               ...
               /*if(worldX + gp.tileSize > gp.player.worldX - gp.player.screenX &&
                ...
                //--------- RENDER ALL ---------------
                  ...
                  g2.drawImage(tile[mapTileNum[i][j]].image, screenX,screenY,gs.TILE_SIZE,gs.TILE_SIZE, null);
                //------------------------------------
