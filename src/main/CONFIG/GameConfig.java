 ...
 *
 * MAP_PATH: xml file generated by Tiled that MUST be in: "res/maps/..."
 */
//----------------------------------------------------------------------------------------------------------------------
public final class GameConfig {
    ...
    private final String TILESET_PATH;
    //-------------------------------------------------------------
 ...
 *                        THE FILE MUST BE IN: "res/maps/mapFileName.tmx"
    ...
    private ArrayList<SpawnPoint> loadEntitySpawns(String EntityName) {
        ...
        for (int i = 0; i < entityGroupList.getLength(); i++) {
            Element obj = (Element) entityGroupList.item(i);
    ...
    private ArrayList<SpawnPoint> loadOBJSpawns(String OBJ_GropupName, int startLayer) {
        ...
        for (int j = 0; j < objects.getLength(); j++) {
            ...
            int worldY = (int) Math.round(y - height);
            spawns.add(new SpawnPoint(worldX,worldY,startLayer));
     ...
     */
    //-------------------------------------------------------------
    private NodeList loadElementGroup(String elementGroupName){
        ...
        for (int g = 0; g < groups.getLength(); g++) {
            ...
            if (groupNode.getNodeType() == Node.ELEMENT_NODE) {
                ...
                // target group find
                if (elementGroupName.equalsIgnoreCase(group.getAttribute("name"))) {
