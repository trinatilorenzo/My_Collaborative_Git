...
public class OBJ_Tree extends GameObject {
    ...
    public Rectangle getSolidWorldArea() { //called by game tinyswordsisland.model to check attack collision with the tree, since the solidArea is relative to the object position we need to get the world coordinates of the solid area
