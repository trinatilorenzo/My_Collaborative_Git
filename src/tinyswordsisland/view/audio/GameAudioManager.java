...
public class GameAudioManager {
    ...
    public void playEvents(AudioEffect effect) {
        ...
        switch (effect) {
            ...
            case PLAYER_ATTACK -> nextSfxPlayer().playOnce(SWORD_SWOOSH_SFX);
    ...
    public void stopAll() {
        ...
        for (AudioPlayer p : sfxPool) p.stopAll();
    }

    public void setMusicVolume(double v) { musicPlayer.setMusicVolume(v); }
    public void setSfxVolume(double v) {
        movementLoopPlayer.setSfxVolume(v);
        for (AudioPlayer p : sfxPool) p.setSfxVolume(v);
    }
    public double getMusicVolume() { return musicPlayer.getMusicVolume(); }
    public double getSfxVolume() { return movementLoopPlayer.getSfxVolume(); }
