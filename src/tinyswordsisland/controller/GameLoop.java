...
import static tinyswordsisland.config.ScreenConfig.*;
...
public class GameLoop extends Thread {
    ...
    public void run() {
        ...
        double fixedDeltaMs = drawInterval / 1_000_000.0; // delta time used by tinyswordsisland.model (ns -> ms) (es. 120 FPS = 8.33 ms)
